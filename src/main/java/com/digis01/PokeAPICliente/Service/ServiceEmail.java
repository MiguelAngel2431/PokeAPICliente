...
//                + "</body></html>";
        String body = "<!DOCTYPE html>\n"
                ...
                + "                <div class=\"emailbody\">\n"
                + "                    <div class=\"header\" style=\"border: 1px solid; margin: 20px;\">\n"
                + "                        <h3 style=\"text-transform: uppercase;\">Autenticación para inicio de sesión</h3>\n"
                + "                    </div>\n"
                + "                    <p>Hola " + nombre + "!,</p>\n"
                + "                    <p>Confirma tu inicio de sesión dando clic al botón de abajo</p>\n"
                + "\n"
                + "                    <div style=\"width: 250px; height: 40px; background-color: green;\">\n"
                + "                        <a href=\"" + url + "\" class=\"btn btn-success\" style=\"text-transform: uppercase; border-radius: 0; width: 250px; height: 40px; background-color: green; text-decoration: none; color: white;\">Autenticarme</a>\n"
                + "                    </div>\n"
                + "                    <br>\n"
                + "                    <br>\n"
                + "                </div>\n"
